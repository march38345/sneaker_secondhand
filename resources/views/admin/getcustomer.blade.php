...
<body>
    ...
    <div class="row side col-12" style="background-color:white">
            ...
            <nav id="sidebar" class="col-md-2 col-lg-2 col-sm-4 bg-dark sidebar"
                ...
                <div class="position-sticky" style="width:100%;height:100%">
                    <ul class="nav flex-column" style="margin-left:5px ">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('getcustomer') }}" class="nav-link"  style="background: white">
        ...
        <div class="col-lg-10 col-sm-8">
            <h1 class="text-light bg-dark col-lg-4 mx-auto">TABLE CUSTOMERS</h1>
            <br>
            <div class="col-lg-10 col-sm-5 tb" >
            <table class="table table-hover table-dark">
                ...
                <tbody>
                    @foreach ($user as $item)
                        ...
                        <td>
                            <a href="/profile/{{$item->id}}" class="btn btn-success">profile</a>
                            <a href="/admin/addtoadmin/{{$item->id}}" class="btn btn-warning">add to admin</a>
